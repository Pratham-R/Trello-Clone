  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} size='medium' title='Help'>
      <Modal.Content style={{ padding: '1rem 1.5rem' }}>
        ...
        <S.Text>
          This is an app where you can <strong>easily</strong> manage your tasks by creating
          specific boards to specific contexts, separating them into columns and task cards.
        </S.Text>
        ...
        <S.Text>
          This project has been developed by <strong>Pratham Rastogi</strong>. <br />
          <br />
          <a href='https://www.linkedin.com/in/prathamrastogi/' target='_blank' rel='noreferrer'>
            Click here to see his LinkedIn.
          </a>
          <br />
          <a href='https://github.com/Pratham-R' target='_blank' rel='noreferrer'>
